...
const Home = () => {
    ...
    if (loading) {
        ...
        return (
            <>
                <div className='bg-[url(https://images.unsplash.com/photo-1601134467661-3d775b999c8b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1550&q=80)] w-full h-screen bg-no-repeat bg-center bg-cover'>
                    {/* overlay */}
